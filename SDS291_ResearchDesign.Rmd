...
stargazer( cit_model, hhd_model, cit_hhd_model, hhd_full_model, citi_fullmodel, full_model, type="latex", header=FALSE,
          ...
          covariate.labels=c("Citizenship Percentage", "Household income (log)" ,"Employment Percentage", "Disabled Percentage", "Marriage Percentage", "Racial Majority: White"),
...
noncit_plot <- ggplot(noncitizen_data, aes(x=notcitizen_pct, y=pred_prob))+
  ...
  geom_line() +
  labs(x = "Percentage of Non U.S. Citizens in the County", y = "Predicted Uninsured Rate", title = "Relationship between U.S. Citizenship Percentage of a county and Uninsured Rates") +
  theme_classic()
```
